...
nohup python3 -m verl.trainer.main_ppo \
    ...
    data.use_dynamic_sampler=False \
    data.init_level=0 \
    ...
    trainer.experiment_name='grpo_qwen2.5_1.5b_math_none_curriculum' \
    trainer.n_gpus_per_node=4 \
    trainer.nnodes=1 \
    trainer.save_freq=-1 \
    trainer.test_freq=5 \
    trainer.total_epochs=30 2>&1 | tee grpo_qwen2.5_1.5b_math_none_curriculum.log &
